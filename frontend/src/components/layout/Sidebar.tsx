  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <button
        ...
        {!collapsed && (
          <span style={{ marginLeft: 10, fontFamily: "'Newsreader', Georgia, serif", fontSize: 22, fontWeight: 400, lineHeight: 1, color: 'var(--app-text)', letterSpacing: '-0.01em', position: 'relative', top: '1px' }}>
            Flyxa
          </span>
        )}
      </button>
